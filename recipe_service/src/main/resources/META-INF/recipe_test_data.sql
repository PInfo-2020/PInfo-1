...
INSERT INTO Recipe (id, name, picture, people, preparationTime, difficulty, preparation, authorId, authorName, publicationDate, grade) VALUES (RECIPE_SEQ.nextval,'Tarte aux citrons', 'monImage', 5, 10, 5, 'Prépare la tarte', 'testId','testName', '2020-07-12', 4.5);
INSERT INTO Recipe (id, name, picture, people, preparationTime, difficulty, preparation, authorId, authorName, publicationDate, grade) VALUES (RECIPE_SEQ.nextval,'Choux à la crème', 'monAutreImage', 2, 15, 3, 'Prépare le choux', 'autreId','autreName', '2020-04-24', 3);
