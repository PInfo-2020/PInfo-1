...
CREATE TABLE IF NOT EXISTS Recipe ( id bigint not null, primary key (id), name varchar(255), picture varchar(255), nbPersons smallint, preparationTime smallint, difficulty smallint, preparation varchar(255), author varchar(255), publicationDate varchar(255), grade float);
...
INSERT INTO Recipe (id, name, picture, nbPersons, preparationTime, difficulty, preparation, author, publicationDate, grade) VALUES (RECIPE_SEQ.nextval,'Tarte aux citrons', 'monImage', 5, 10, 5, 'Prépare la tarte', 'testId', '2020-07-12', 4.5);
INSERT INTO Recipe (id, name, picture, nbPersons, preparationTime, difficulty, preparation, author, publicationDate, grade) VALUES (RECIPE_SEQ.nextval,'Choux à la crème', 'monAutreImage', 2, 15, 3, 'Prépare le choux', 'autreId', '2020-04-24', 3);
