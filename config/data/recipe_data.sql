...
drop table Ustensiles if exists;
...
INSERT INTO Ustensiles(id, id_recipe, ustensile) VALUES (1,(SELECT id from Recipe WHERE nom='Abricot sucré'), 'Casserole');
INSERT INTO Ustensiles(id, id_recipe, ustensile) VALUES (2, (SELECT id from Recipe WHERE nom='Abricot sucré'), 'poele');
INSERT INTO Ustensiles(id, id_recipe, ustensile) VALUES (3, (SELECT id from Recipe WHERE nom='Abricot sec sucré'), 'spatulle');
INSERT INTO Ustensiles(id, id_recipe, ustensile) VALUES (4, (SELECT id from Recipe WHERE nom='Abricot sec sucré'), 'four');
...
TRUNCATE TABLE Tags; 
INSERT INTO Tags(id, id_recipe, tag) VALUES (1,(SELECT id from Recipe WHERE nom='Abricot sucré'), 'vegan');
INSERT INTO Tags(id,id_recipe, tag) VALUES (2, (SELECT id from Recipe WHERE nom='Abricot sucré'), 'sucré');
INSERT INTO Tags(id, id_recipe, tag) VALUES (3,(SELECT id from Recipe WHERE nom='Abricot sec sucré'), 'sec');
INSERT INTO Tags(id,id_recipe, tag) VALUES (4,(SELECT id from Recipe WHERE nom='Abricot sec sucré'), 'sucré');
...
INSERT INTO IngredientsRecipe(id,id_recipe, ingredient, quantite) VALUES (1,(SELECT id from Recipe WHERE nom='Abricot sucré'), 1, 4);
INSERT INTO IngredientsRecipe(id,id_recipe, ingredient, quantite) VALUES (2,(SELECT id from Recipe WHERE nom='Abricot sucré'), 735, 30);
INSERT INTO IngredientsRecipe(id, id_recipe, ingredient, quantite) VALUES (3,(SELECT id from Recipe WHERE nom='Abricot sec sucré'), 2, 10);
INSERT INTO IngredientsRecipe(id,id_recipe, ingredient, quantite) VALUES (4,(SELECT id from Recipe WHERE nom='Abricot sec sucré'), 735, 20);
